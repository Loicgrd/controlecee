...
_RAW_TABLE = [
    ...
    (["BAR-EN-101"], [
        # Périodes antérieures à 2022 (taux "GPE", source : Tx_de_Satisfaisant_et_catégorie_de_lot.xlsx)
        (date(2000, 1, 1), date(2020, 8, 31), 10.0, None),
        (date(2020, 9, 1), date(2021, 6, 30), 10.0, None),
        (date(2021, 7, 1), date(2021, 12, 31), 10.0, None),
    ...
    (["BAR-EN-102"], [
        # Périodes antérieures à 2022 (taux "GPE") : aucune donnée avant le 01/07/2021.
        (date(2021, 7, 1), date(2021, 12, 31), 10.0, 20.0),
        (date(2022, 1, 1), date(2022, 12, 31), 7.5, 15.0),
        (date(2023, 1, 1), date(2023, 12, 31), 10.0, 20.0),
        (date(2024, 1, 1), date(2024, 12, 31), 12.5, 25.0),
        (date(2025, 1, 1), date(2026, 12, 31), 15.0, 30.0),
    ...
    (["BAR-EN-103"], [
        # Périodes antérieures à 2022 (taux "GPE")
        (date(2000, 1, 1), date(2020, 8, 30), 10.0, None),
        (date(2020, 9, 1), date(2021, 6, 30), 20.0, None),
        (date(2021, 7, 1), date(2021, 12, 31), 20.0, None),
        (date(2022, 1, 1), date(2022, 12, 31), 7.5, 15.0),
        (date(2023, 1, 1), date(2023, 12, 31), 10.0, 20.0),
        (date(2024, 1, 1), date(2024, 12, 31), 12.5, 25.0),
        (date(2025, 1, 1), date(2026, 12, 31), 15.0, 30.0),
    ...
    (["BAR-EN-106", "BAR-EN-107", "BAR-TH-145", "BAR-TH-164"], [
        # Pas de donnée antérieure à 2022 disponible pour ces fiches.
        (date(2022, 1, 1), date(2022, 12, 31), 7.5, 15.0),
        (date(2023, 1, 1), date(2023, 12, 31), 10.0, 20.0),
        (date(2024, 1, 1), date(2024, 12, 31), 12.5, 25.0),
        (date(2025, 1, 1), date(2026, 12, 31), 15.0, 30.0),
